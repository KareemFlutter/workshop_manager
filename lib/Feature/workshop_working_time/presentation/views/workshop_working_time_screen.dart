...
class WorkshopWorkingTimeScreen extends StatefulWidget {
  const WorkshopWorkingTimeScreen({super.key});

  @override
  State<WorkshopWorkingTimeScreen> createState() =>
      _WorkshopWorkingTimeScreenState();
}

class _WorkshopWorkingTimeScreenState extends State<WorkshopWorkingTimeScreen> {
  @override
